...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [79.767049, 6.672659, 80.355163, 7.054441], maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:4326',
            //extent: [62431.289062, 80387.671875, 322115.000000, 513493.093750],
            units: 'degrees'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([79.767049, 6.672659, 80.355163, 7.054441], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">GNDs of Seethawaka Pradeshiya Sabha</h2>';
        return titleElement;
    })(),
